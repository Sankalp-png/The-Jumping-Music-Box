...
helpers = function () {
   ...
   *
   *    // load either beatball.mp3, or .ogg, depending on browser
   *    mySound = loadSound('assets/beatball.mp3');
   *  }
   *
   *  function setup() {
   *    mySound.play();
...
soundfile = function () {
   ...
   *  function preload() {
   *    soundFormats('ogg', 'mp3');
   *    soundFile = loadSound('assets/beatball.mp3');
   *  }
   *
   *  function draw() {
   *    background(0);
...
reverb = function () {
   ...
   *    // 'concrete-tunnel' 'small-plate' 'drum' 'beatball'
...
looper = function () {
   ...
   *    masterVolume(0.1);
   *
   *    myPhrase = new p5.Phrase('bball', makeSound, pattern);
   *    myPart = new p5.Part();
   ...
   *  @example
   *  <div><code>
   *  let ball, drum, myPart;
   *  let ballPat = [1,0,0,2,0,2,0,0];
   *  let drumPat = [0,1,1,0,2,0,1,0];
   *  let msg = 'click to play';
   *
   *  function preload() {
   *    ball = loadSound('assets/beatball.mp3');
   *    drum = loadSound('assets/drum.mp3');
   *  }
   *
   *  function setup() {
   ...
   *    masterVolume(0.1);
   *
   *    let ballPhrase = new p5.Phrase('ball', playball, ballPat);
   *    let drumPhrase = new p5.Phrase('drum', playDrum, drumPat);
   *    myPart = new p5.Part();
   *    myPart.addPhrase(ballPhrase);
   ...
   *  }
   *
   *  function playball(time, playbackRate) {
   *    ball.rate(playbackRate);
   *    ball.play(time);
   *  }
   *
